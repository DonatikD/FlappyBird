...
//
//	mainWindow.create(sf::VideoMode(1200, 750), L"Öå ìîÿ íàéêðàùà ïðîãðàìà");
...
////
////        // Âñòàíîâëþºìî ïîçèö³þ êíîïêè
////        m_shape.setPosition(x, y);
////    }
////
////    // Ìåòîä äëÿ ìàëþâàííÿ êíîïêè
////    void draw(sf::RenderWindow& window) {
////        window.draw(m_shape);
////    }
////
////    // Ìåòîä äëÿ ïåðåâ³ðêè, ÷è íàâåäåíèé êóðñîð ìèø³ íà êíîïêó
////    bool isMouseOver(sf::RenderWindow& window) {
////        sf::Vector2f mousePosition = sf::Vector2f(sf::Mouse::getPosition(window));
////        return m_shape.getGlobalBounds().contains(mousePosition);
////    }
////
////    // Ìåòîä äëÿ îíîâëåííÿ ñòàíó êíîïêè (íàïðèêëàä, çì³íè êîëüîðó ïðè íàâåäåíí³ êóðñîðà ìèø³)
////    void update(sf::RenderWindow& window) {
////        if (isMouseOver(window)) {
////            // Çì³íþºìî ðîçì³ð êíîïêè ïðè íàâåäåíí³ êóðñîðà ìèø³
////            /*m_shape.setSize(sf::Vector2f(m_shape.getSize().x * 0.9f, m_shape.getSize().y * 0.9f));*/
////            m_shape.setScale(0.55, 0.55);
////        }
////        else {
////            // Â³äíîâëþºìî ïî÷àòêîâèé ðîçì³ð êíîïêè
////           // m_shape.setSize(sf::Vector2f(m_initialSize.x, m_initialSize.y));
////            m_shape.setScale(0.6, 0.6);
////        }
////    }
////
////    // Ìåòîä äëÿ âñòàíîâëåííÿ òåêñòóðè íà êíîïêó
...
////    sf::Vector2f m_initialSize; // Ïî÷àòêîâèé ðîçì³ð êíîïêè
////};
//
//
////sf::RectangleShape m_shape;
...
////         // Îáðîáêà ïîìèëêè ïðè çàâàíòàæåíí³ øðèôòó
////         return -1;
////     }
////    
////     
...
////                     // Îáðîáêà âèáîðó "Start"
////                     // Äîäàéòå êîä äëÿ âèêëèêó ãðè àáî ³íøî¿ ëîã³êè
////                     std::cout << "Start selected!" << std::endl;
////                 }
////                 else if (event.key.code == sf::Keyboard::Num2) {
////                     // Îáðîáêà âèáîðó "Options"
////                     // Äîäàéòå êîä äëÿ âèêëèêó åêðàíó íàëàøòóâàíü àáî ³íøî¿ ëîã³êè
